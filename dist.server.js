    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                const options = {
      key: fs.readFileSync('/etc/letsencrypt/live/cerden.net/privkey.pem'),
      cert: fs.readFileSync('/etc/letsencrypt/live/cerden.net/fullchain.pem'),
    };
                nextApp.prepare().then(function () {
                    payload_1.default.logger.info('Starting Next.js...');
                     https.createServer(options, app).listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
